"""
Django settings for backlog_gamer project.
...
SECRET_KEY = 'django-insecure-lkdb3^4cm(jk#nw4)1_@hvyu5=%wf=5@^vpu^u&xkoclzif=q5'
...
ROOT_URLCONF = 'backlog_gamer.urls'
...
WSGI_APPLICATION = 'backlog_gamer.wsgi.application'
